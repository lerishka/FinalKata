AAA;EApBN;EAuBE;IACI,aAAA;EArBN;EAwBE;IACI,aAAA;EAtBN;EAyBE;IACI,aAAA;EAvBN;EA0BE;IACI,UAAA;EAxBN;AACF","sourcesContent":["@font-face {\n    font-family: 'TT Lakes';\n    src: url('./fonts/TTLakes-Regular.woff2') format('woff2');\n    font-weight: 400;\n    font-style: normal;\n    font-display: swap;\n}\n\n@font-face {\n    font-family: 'TT Lakes';\n    src: url('./fonts/TTLakes-Medium.woff2') format('woff2');\n    font-weight: 500;\n    font-style: normal;\n    font-display: swap;\n}\n\n@font-face {\n    font-family: 'TT Lakes';\n    src: url('./fonts/TTLakes-Bold.woff2') format('woff2');\n    font-weight: 700;\n    font-style: normal;\n    font-display: swap;\n}\n\nbody {\n    background-color: #F8F8F8;\n    margin: 0;\n    max-width: 1120px;\n    margin-left: auto;\n    margin-right: auto;\n}\n\n.swiper {\n    height: 70px;\n    margin-left: 16px;\n    margin-top: 16px;\n    margin-right: 16px;\n    padding-bottom: 40px;\n  }\n\n.top {\n    background-image: linear-gradient(#F8F8F8, #FFFFFF);\n}\n\n.top::before {\n    display: block;\n    content: '';\n    height: 1px;\n    width: auto;\n    background-color: #D9FFF5;\n}\n\n.top__desription {\n    font-family: 'TT Lakes';\n    font-weight: 400;\n    font-style: normal;\n    columns: #7E7E82;\n    text-transform: uppercase;\n    padding: 16px;\n    margin: 0;\n    font-size: 16px;\n    line-height: 24px;\n}\n\n\n.swiper.swiper-initialized.swiper-horizontal.swiper-android.swiper-backface-hidden {\n    margin-left: 16px;\n}\n\n.swiper-wrapper {\n    display: flex;\n    height: 72px;\n}\n\n.swiper-slide {\n    display: flex;\n    justify-content: space-between;\n    background-color: #FFFFFF;\n    min-width: 240px;\n    height: 72px;\n    box-sizing: border-box;\n    padding: 16px;\n    align-items: center;\n    border-radius: 6px;\n    border: 1px solid #EAEAEA;\n}\n\n.swiper-pagination {\n    bottom: 100px;\n}\n\nspan.swiper-pagination-bullet {\n    background-color: #DDDDDD;\n    width: 12px;\n    height: 12px;\n    opacity: 1;\n    margin-right: 12px;\n}\n\n.swiper-pagination-bullet.swiper-pagination-bullet-active {\n    background-color: #B5B6BC;\n}\n\n\n.item__link {\n    width: 40px;\n    height: 40px;\n    background-image: url(./icons/link-icon.svg);\n    background-position: center;\n    border: 0;\n    background-color: #FFFFFF;\n}\n\n\n.show-more {\n    position: relative;\n    font-family: 'TT Lakes';\n    border: none;\n    background-color: #F8F8F8;\n    margin: 16px;\n    padding: 0;\n    margin-left: 41px;\n    opacity: 0;\n    top: 60px;\n    color:#1B1C21;\n}\n\n.show-more.moved {\n    top: 150px;\n}\n\n.show-more::before {\n    position: absolute;\n    content: url(./icons/up-icon.svg);\n    background-position: center;\n    background-repeat: no-repeat;\n    background-size: 50%;\n    width: 8px;\n    height: 10px;\n    left: -24px;\n    opacity: 0;\n    transform: rotate(180deg);\n    top: 6px;\n}\n\n.show-more.moved::before {\n    transform: rotate(0deg);\n    top: 1px;\n}\n\n\n@media (min-width: 768px) {\n\n    .show-more {\n        opacity: 1;\n    }\n    \n    .show-more::before {\n        opacity: 1;\n    }\n\n    .swiper-pagination {\n        opacity: 0;\n    }\n\n    .swiper{\n        overflow: visible;\n    }\n\n    .swiper-wrapper {\n        display: flex;\n        flex-wrap: wrap;\n        column-gap: 24px;\n        row-gap: 16px;\n    }\n\n    .swiper-slide {\n        width: calc(33.33% - 16px);\n        min-width: 224px;\n    }\n\n    .slide-show {\n        display: flex;\n    }\n\n    .slide-none {\n        display: none;\n    }\n\n    .show-more.moved {\n        top: 240px;\n    }\n\n\n}\n\n@media (min-width: 1120px) {\n\n    .swiper-slide {\n        width: 240px;\n        flex-grow: 0;\n    }\n\n    .swiper-wrapper {\n        column-gap: 32px;\n        row-gap: 16px;\n    }\n\n    .slide-show {\n        display: flex;\n    }\n\n    .slide-none {\n        display: none;\n    }\n\n    .slide-none:nth-child(7), .slide-none:nth-child(8) {\n        display: flex;\n    }\n\n    .show-more.moved {\n        top: 150px;\n    }\n\n}"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/styles/fonts/TTLakes-Bold.woff2":
/*!*********************************************!*\
  !*** ./src/styles/fonts/TTLakes-Bold.woff2 ***!
  \*********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "cdc7dcddf6ee8d85fcc2.woff2";

/***/ }),

/***/ "./src/styles/fonts/TTLakes-Medium.woff2":
/*!***********************************************!*\
  !*** ./src/styles/fonts/TTLakes-Medium.woff2 ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "e781c4423f37bcb7f986.woff2";

/***/ }),

/***/ "./src/styles/fonts/TTLakes-Regular.woff2":
/*!************************************************!*\
  !*** ./src/styles/fonts/TTLakes-Regular.woff2 ***!
  \************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "fa93e70b0194a593ac03.woff2";

/***/ }),

/***/ "./src/styles/icons/link-icon.svg":
/*!****************************************!*\
  !*** ./src/styles/icons/link-icon.svg ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "1e4d87b74a783964edbc.svg";

/***/ }),

/***/ "./src/styles/icons/up-icon.svg":
/*!**************************************!*\
  !*** ./src/styles/icons/up-icon.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "ca7f7784a1eed197985d.svg";
...
var swiper;
function initSwiper() {
  swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.swiper', _defineProperty(_defineProperty({
...
var noneSlides = document.querySelectorAll('.slide-none');
var isEmpty = false;
showMore.addEventListener('click', function () {
  if (isEmpty === true) {
    noneSlides.forEach(function (noneSlide) {
      noneSlide.classList.add('slide-none');
    });
    isEmpty = false;
  } else {
    noneSlides.forEach(function (noneSlide) {
      noneSlide.classList.remove('slide-none');
    });
    isEmpty = true;
  }
  if (showMore.textContent === 'Показать все') {
    showMore.textContent = 'Скрыть';
    showMore.classList.add('moved');
  } else {
    showMore.textContent = 'Показать все';
    showMore.classList.remove('moved');
  }
});
})();
